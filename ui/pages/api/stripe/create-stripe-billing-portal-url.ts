...
export default handler().get(async (req, res) => {
    ...
    if (typeof groupId !== "string") throw new Error("groupId missing or not a string");
    ...
    if (!groupMember.isAdmin) throw new Error("You need to be admin to access billing portal");
