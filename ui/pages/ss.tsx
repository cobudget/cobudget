...
function SS () {
    ...
    const [{data, fetching}] = useQuery({ query: GET_SUPER_ADMIN_SESSIONS, variables: { offset, limit } });
    ...
    const sessions = useMemo(() => {
        if (data?.getSuperAdminSessions.sessions) {
            ...
            sessionsRef.current = sessionsRef.current.concat((data?.getSuperAdminSessions.sessions || []));
