    ...
    return (
      <li className="group bg-white p-4 mb-3 rounded shadow list-none">
        <div className="flex items-center justify-between">
          <h2 className="font-semibold text-lg" data-testid="customfield-name-view">{customField.name}</h2>
          <div>
            <Tooltip
        ...
        <p className="mb-2" data-testid="customfield-description-view">{customField.description}</p>
        <div className="flex">
