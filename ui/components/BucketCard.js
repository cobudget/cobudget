...
const BucketCard = ({ bucket, round }) => {
  ...
  return (
    <div data-testid="bucket-card" className="relative bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-full hover:shadow-lg transition-shadow duration-75 ease-in-out">
