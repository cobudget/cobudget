...
function Infobox ({
    ...
    const status = useMemo(() => {
        if (userType === "admin" && bucket.status === "IDEA") {
            return bucket.readyForFunding ? "READY_FOR_FUNDING" : "NOT_READY_FOR_FUNDING"
        }
        else {
    ...
    const messages = useMemo(() => ({
        ...
        cocreator: {
            ...
            IDEA: {
                allowed: "To start collecting funds for this bucket, open it for funding.",
                notAllowed: "This bucket is waiting for an admin to open it for funding."
            },
            OPEN_FOR_FUNDING: {
                allowed: "To accept funding, funds raised must match your budget. Edit your budget below to match the funding you received.",
                notAllowed: "To accept funding, funds raised must match your budget. Only admins can edit budgets after funding starts."
            },
            FUNDED: {
                allowed: "When you have used your funding, you can mark this bucket as completed. Remember that it is usually appreciated to write a short message in the comments about how it turned out.",
                notAllowed: "When you have used your funding, you can mark this bucket as completed. Remember that it is usually appreciated to write a short message in the comments about how it turned out."
            }
        },
        user: {
