    ...
    <div className="flex my-4">
      ...
      >
        <div className="flex justify-between items-center mb-2 text-gray-900 font-medium">
          {comment.isLog ? (
            <h5><FormattedMessage defaultMessage = "Log" /></h5>
          ) : comment.roundMember === null ? (
            <h5><FormattedMessage defaultMessage = "A discourse user" /></h5>
          ) : (
            ...
            {canEdit && (
              <div className="flex">
                <button
                  onClick={() =>
                    confirm(
                      intl.formatMessage({ defaultMessage:"Are you sure you would like to delete this comment?"})
                    ) &&
                    deleteComment({
                      bucketId: bucket.id,
                ...
                >
                  ...
                  <span><FormattedMessage defaultMessage="Delete" /></span>
                </button>
                <button
                ...
                >
                  ...
                  <span><FormattedMessage defaultMessage ="Edit" /></span>
                </button>
              </div>
            )}
          </>
